...
public class ManagerRegistrationActivity extends AppCompatActivity {
    ...
    backButton.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
            Intent intent = new Intent(ManagerRegistrationActivity.this, LoginActivity.class);
    ...
    mAuth = FirebaseAuth.getInstance();
        ...
        public void onClick(View view) {
            ...
            if (donationtype.equals("Select your Request")){
                Toast.makeText(ManagerRegistrationActivity.this, "Select Donation request", Toast.LENGTH_SHORT).show();
                return;
            }
                        ...
                        if(task.isSuccessful()){
                            ...
                            userDatabaseRef.updateChildren(userinfo).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    if (task.isSuccessful()){
                                        Toast.makeText(ManagerRegistrationActivity.this, "Data set Successful", Toast.LENGTH_SHORT).show();
                                    }else {
                            ...
                            if (resultUri !=null){
                                ...
                                uploadTask.addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(ManagerRegistrationActivity.this, "Image Upload Failed", Toast.LENGTH_SHORT).show();
                                    }
                                });
